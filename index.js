...
/* const producto1 = new Product("Consola", "Series S", 300, "", "abc1", true)
const producto2 = new Product("Consola", "Playstation 4", 300, "", "abc2", true)
const producto3 = new Product("Consola", "Playstation 5", 500, "", "abc3", true)
const producto4 = new Product("Consola", "Nintendo Switch", 400, "", "abc4", true)
 */
